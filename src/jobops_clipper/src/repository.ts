...
import { 
  ...
  PositionDetailsRecord,
  JobRequirementsRecord,
  CompanyInformationRecord,
  SkillsMatrixRecord,
  SkillAssessmentRecord,
  ApplicationMaterialsRecord,
...
export class JobOpsDataManager {
  private currentJobApplicationId: string | null = null;
  private currentCanonicalUrl: string | null = null;
  ...
  async checkAndLoadExistingJob(url: string): Promise<boolean> {
    try {
  ...
  async createNewJobApplication(jobData: any): Promise<string> {
    try {
  ...
  async loadJobApplicationData(jobApplicationId: string): Promise<void> {
    try {
  ...
  async savePositionDetails(data: any): Promise<void> {
  ...
  async saveJobRequirements(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  async saveCompanyInformation(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  // Save skills matrix
  async saveSkillsMatrix(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
    ...
    try {
      ...
      if (data.assessments && Array.isArray(data.assessments)) {
        for (const assessment of data.assessments) {
          ...
          await jobOpsDatabase.saveSectionData('skill_assessments', skillAssessmentData as any);
        }
      }
  ...
  async saveApplicationMaterials(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  async saveInterviewSchedule(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  async saveInterviewPreparation(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  async saveCommunicationLog(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  // Save key contacts
  async saveKeyContacts(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  async saveInterviewFeedback(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  // Save offer details
  async saveOfferDetails(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  async saveRejectionAnalysis(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  // Save privacy policy
  async savePrivacyPolicy(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  async saveLessonsLearned(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  async savePerformanceMetrics(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  // Save advisor review
  async saveAdvisorReview(data: any): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  async updateJobStatus(status: string): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  getCurrentJobApplicationId(): string | null {
    return this.currentJobApplicationId;
  }

  // Get current canonical URL
  getCurrentCanonicalUrl(): string | null {
  ...
  async exportCurrentJobApplication(): Promise<any> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
  ...
  async deleteCurrentJobApplication(): Promise<void> {
    if (!this.currentJobApplicationId) {
      throw new Error('No active job application');
    }
